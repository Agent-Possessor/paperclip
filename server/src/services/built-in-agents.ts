...
const DEFINITIONS = validateBuiltInAgentDefinitions([
  {
    ...
    defaultRole: "general",
    allowedAdapterTypes: ["codex_local", "claude_local", "antigravity_local", "opencode_local", "process"],
  ...
  },
  {
    ...
    allowedAdapterTypes: ["claude_local", "codex_local", "antigravity_local", "opencode_local", "process"],
    defaultBudgetMonthlyCents: 0,
    bundle: {
