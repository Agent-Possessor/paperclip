...
- `agent-guidelines/sales-faq-objections.md` for sales-friendly answers.
- `operations/feature-status-and-claim-boundaries.md` for what is safe to claim.

## Evidence
- `references/source-map.md` for source confidence.
